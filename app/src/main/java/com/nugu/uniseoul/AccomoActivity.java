...
public class AccomoActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.accomo_recyclerview);
        drawerLayout = (DrawerLayout) findViewById(R.id.accomo_drawerlayout);
        toolbar = (Toolbar) findViewById(R.id.toolbar);
        listView = (ListView) findViewById(R.id.accomo_drawer_list);
        drawer = (LinearLayout)findViewById(R.id.accomo_drawer);
        slideViewPager = (ViewPager)findViewById(R.id.accomo_viewpager);
        tabLayout = (TabLayout)findViewById(R.id.accomo_tablayout);
        ...
        try{
            //숙박json파일 데이터 가져오기
            InputStream is = getAssets().open("seoulaccomo.json");
        ...
        mAdapter = new CourseRecyclerViewAdapter(course, AccomoActivity.this);
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
            switch (position) {
                case 0:
                    startActivity(new Intent(AccomoActivity.this,MainActivity.class));
                    break;
                case 1:
                    startActivity(new Intent(AccomoActivity.this,RestaurantActivity.class));
                    break;
                case 2:
                    break;
            }
